...
public class MainActivity extends AppCompatActivity {
    ...
    public int wordCol, definitionCol;
    ...
    public TextView wordTextView, definationTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        definationTextView = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        if (mData != null) {
            ...
            definationTextView.setVisibility(View.INVISIBLE);
            ...
            definationTextView.setText(mData.getString(definitionCol));
    ...
    public void showDefinition() {
        ...
        if (mData != null) {
            ...
            definationTextView.setVisibility(View.VISIBLE);
